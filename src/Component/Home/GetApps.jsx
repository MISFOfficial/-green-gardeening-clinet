...
const GetApps = () => {
    ...
    return (
        <div class={`flex items-center justify-center h-100  ${theme ? 'dark': 'bg-gray-100'}`}>
            <div>
                <h2 class={`text-3xl ${theme ? 'text-white' : 'text-black'} font-extrabold my-3 text-center`}>Get Our app</h2>
                <div class="flex flex-col w-full gap-2 p-2 md:flex-row">
                    <a href="" target="_blank"
                        class="flex items-center justify-center w-full px-5 py-3 text-center text-white bg-white rounded-2xl"
                        rel="noreferrer">

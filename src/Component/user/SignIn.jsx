...
import { FaEye, FaEyeSlash, FaHouseChimneyWindow, FaPagelines, FaUser } from 'react-icons/fa6';
...
const SignIn = () => {
    ...
    const { signIn, google, loading, } = use(AuthContext)
            ...
            <div className="min-h-screen flex flex-col items-center justify-center py-6 px-4 hero-overlay">
                <div className="max-w-md w-full">
                    <div className="p-8 rounded-2xl bg-white shadow">
                        ...
                        <h2 className="text-[black] text-center text-3xl font-semibold mt-5">Sign in</h2>
                        <button onClick={handleGoogle} className='mt-5 shadow-md flex text-black cursor-pointer w-full justify-center p-3 rounded-lg border border-[black]'>
                        ...
                        {/* form */}
                        <div className='divider divider-neutral text-xl text-black mt-6'>or</div>
                        <form onSubmit={handleSignin} className="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <div className="relative flex items-center">
                                    ...
                                    <p onClick={() => setShowpass(!showpass)} className='absolute right-4 text-gray-500 cursor-pointer'>
                                        {
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-4">
                                ...
                                <div className="text-sm">
                                    <span className="cursor-pointer text-blue-600 hover:underline font-semibold">
                            ...
                            <p className="text-slate-800 text-sm !mt-6 text-center">Don't have an account? <Link to='/register' className="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Register here</Link ></p>
                        </form>
                    </div>
                </div>
            </div>
